    ...
    if (_nameError == null &&
      ...
      try {
        ...
        if (response.statusCode == 201) {
          ...
          if (!mounted) return;
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(error['message'] ?? 'Registrasi Gagal')),
          );
        }
      } catch (e) {
        if (!mounted) return;
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSocialButton(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Fitur Google Register belum tersedia')),
                  );
                },
              ),
              ...
              _buildSocialButton(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Fitur Facebook Register belum tersedia')),
                  );
                },
              ),
